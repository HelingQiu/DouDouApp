...
- (void)initCityPickerView{
    ...
    [btnCancel setTitleColor:kHexColor(@"#ffba07") forState:UIControlStateNormal];
    [btnCancel setTitleColor:kHexColor(@"#ffba07") forState:UIControlStateHighlighted];
    ...
    [btnSure setTitleColor:kHexColor(@"#ffba07") forState:UIControlStateNormal];
    [btnSure setTitleColor:kHexColor(@"#ffba07") forState:UIControlStateHighlighted];
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    if (component == PROVINCE_COMPONENT) {
        ...
        myView.font = [UIFont boldSystemFontOfSize:16];
